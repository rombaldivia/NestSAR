...
Audited D128/T16 baseline trainer.

Reference result:
  NTU120 XSUB: 73.24771%
...
print("Audited GFLOPs:         0.067242094 @ T16/D128/M64/R32")
print("Best audited XSUB:      73.24771%")
print("=" * 120)
