...
'''
    ...
    print("=" * 120)
    print("M4-PHASE-JITTER-CONSISTENCY-T64-TEACHER | ISOLATED TPU RUNTIME PROBE")
    print("=" * 120)
    ...
    print("TPU_RUNTIME_PROBE=PASS | backend=tpu | local_devices=8")


def main() -> int:
    probe_tpu()
    run_child("experiments.m4_phase_jitter_consistency_t64_teacher.preflight_tpu8")
    print("PREFLIGHT PASSED — STARTING MATCHED T64 TEACHER TRAINING")
    run_child(
        "experiments.m4_phase_jitter_consistency_t64_teacher.train_tpu",
        "--protocol", "both",
        "--epochs", "60",
        "--patience", "15",
        "--batch-size", "64",
        ...
        "--progress-every", "10",
        "--audit-first",
        "--outdir", "/kaggle/working/NestSAR_M4_Phase_JitterConsistency_T64_Teacher_TPU",
    )
    return 0
