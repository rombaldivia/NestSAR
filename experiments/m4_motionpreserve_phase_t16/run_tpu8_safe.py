...
"""Process-isolated Kaggle TPU v5e-8 launcher for Phase-T16."""
...
'''
    ...
    print("M4-MOTIONPRESERVE-PHASE-T16 | ISOLATED TPU RUNTIME PROBE", flush=True)
    print("=" * 120, flush=True)
...
def main() -> int:
    probe_tpu()
    run_child("experiments.m4_motionpreserve_phase_t16.preflight_tpu8")

    print(
        "PREFLIGHTS PASSED — STARTING MOTIONPRESERVE PHASE-T16 TRAINING",
        flush=True,
    )

    run_child(
        "experiments.m4_motionpreserve_phase_t16.train_phase_t16_tpu",
        "--protocol", "both",
        "--selector", "segment",
        "--epochs", "60",
        "--patience", "12",
        ...
        "--progress-every", "5",
        "--audit-first",
        "--outdir", "/kaggle/working/NestSAR_M4_MotionPreserve_Phase_T16_TPU",
    )
    return 0
