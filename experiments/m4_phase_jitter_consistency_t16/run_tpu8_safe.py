...
"""Process-isolated launcher for Phase-T16 jitter consistency training."""
...
'''
    ...
    print("M4-PHASE-JITTER-CONSISTENCY-T16 | ISOLATED TPU RUNTIME PROBE", flush=True)
    print("=" * 120, flush=True)
...
def main() -> int:
    probe_tpu()
    run_child("experiments.m4_phase_jitter_consistency_t16.preflight_tpu8")

    print("PREFLIGHTS PASSED — STARTING PHASE-T16 JITTER CONSISTENCY TRAINING", flush=True)
    run_child(
        "experiments.m4_phase_jitter_consistency_t16.train_tpu",
        "--protocol", "both",
        "--epochs", "60",
        "--patience", "12",
        "--batch-size", "256",
        ...
        "--progress-every", "5",
        "--audit-first",
        "--outdir", "/kaggle/working/NestSAR_M4_Phase_JitterConsistency_T16_TPU",
    )
    return 0
