...
'''
    ...
    print("M4-PHASE-JITTER-CONSISTENCY-RICHROUTER-T16 | TPU8 PROBE", flush=True)
    print("=" * 120, flush=True)
...
def main() -> int:
    ...
    run_child(
        "experiments.m4_phase_jitter_consistency_richrouter_t16.preflight_tpu8"
    )

    print("PREFLIGHT PASSED — STARTING RICH-ROUTER ABLATION", flush=True)

    run_child(
        "experiments.m4_phase_jitter_consistency_richrouter_t16.train_tpu",
        "--protocol", "both",
        "--epochs", "60",
        "--patience", "12",
        "--batch-size", "256",
        ...
        "--audit-first",
        "--outdir",
        "/kaggle/working/NestSAR_M4_Phase_JitterConsistency_RichRouter_T16_TPU",
    )
    return 0
